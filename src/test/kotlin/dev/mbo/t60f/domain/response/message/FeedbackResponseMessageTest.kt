...
class FeedbackResponseMessageTest {
    ...
    inner class ProxyCase {
        ...
        fun bobToChiara() {
            ...
            assertThat(FeedbackResponseMessage.calculateTo(BOB, response1Message1)).isEqualTo(CHIARA)
        }

        @Test
        fun chiaraToBob() {
            // chiara answers to bob
            assertThat(FeedbackResponseMessage.calculateTo(CHIARA, response1Message2)).isEqualTo(BOB)
        }
    }
    ...
    inner class SimpleCase {
        ...
        fun aliceToBob() {
            ...
            assertThat(FeedbackResponseMessage.calculateTo(ALICE, response1Message1)).isEqualTo(BOB)
        }

        @Test
        fun bobToAlice() {
            // bob is logged in and answers to alice
            assertThat(FeedbackResponseMessage.calculateTo(BOB, response1Message2)).isEqualTo(ALICE)
        }
    }
